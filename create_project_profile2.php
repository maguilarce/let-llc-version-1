                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="panel-title">
                                ...
                                <h4>Create Project Profile - Step 2/4</h4>
                                <h6>Select the state(s) where the project will be developed:</h6>
                            </div>
                        </div>
         
                        
                        <form method="post" action="create_project_profile3.php" onsubmit="return verificar(this)">
