...
$level=5;
$query2 = "SELECT * from user WHERE login='$user_au'";
$res2 =  mysql_query($query1);
$row2 = mysql_fetch_array($res2);
$u_type = $row2['type'];
if($u_type=="admin"){$level=1;}
if($u_type=="superintendent"){$level=2;}
if($u_type=="manager"){$level=3;}
if($u_type=="foreman"){$level=4;}
if($user_au==9999){$level=5;}
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="panel-title">
                                ...
                                <h4>Edit Project Profile - Step 3/4</h4>
                                <h6>Select the county or counties where the project will be developed:</h6>
                            </div>
                        </div>
         
                        
                        <form method="GET" action="edit_project_profile4.php" >
